    	...
    	<form>
        	...
        	<div class="mb-3">
  			...
  			<div class="d-flex align-items-center justify-content-between mb-2">
  				...
  				<a href="JavaScript: void(0)" class="text-secondary text-decoration-none" >Recuperar Senha</a>
  			</div>
      		</div>
    		...
    		<div class="container-fluid">
    			<div class="row">
    				...
    				<div class="col-md-6 ps-0 mb-3">
    					...
    					<input type="text" class="form-control shadow-none" placeholder="9 9999-9999">
    				</div>
    				<div class="col-md-6 p-0">
